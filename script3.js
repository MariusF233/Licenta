...
nume_luni.forEach((e, index) => {
  ...
  luna.onclick = () => {
    ...
    genereazaOre(luna_curenta.value, an_curent.value);
  };
...
genereazaOre = (luna,an)=>{

let lista_ore=document.querySelector(".lista-ore-header");
lista_ore.innerHTML="";
let span_data=document.createElement("div");
span_data.innerHTML=`<span name="span-cu-data" class="span-cu-data">${nume_luni[luna]} ${an}</span>`;
